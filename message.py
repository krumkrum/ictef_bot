class BotMessange(object):
    ...
    CONTACT = u"""Сайт ИЦТЭФ: phys.asu.ru
...
/forward всем
    ...
    ERROR = u"""Извните я не понимаю ваш вопрос"""
    DATA_UPDATE = "Ваши данные обновлены"
    ROLE = [u"Студент", u"Преподователь", u"Абитуриент"]
    START_TEXT = [u'Расписание', u'Заказать справку', u'Общежитие', u'Контакты', u'FAQ']
    FAQ_TEXT = [u'Потерял студенческий/зачетку']
    DOM_TEXT = [u"Заселение"]
    SCHEDULE = [u"Предыдущая", u"Текущая", u"Следующая"]

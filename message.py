TEXT_HELP = u"""Этот создан для помощи студентам"""
TEXT_CONTACT = u"""
...
"""
TEXT_PRIEZD = u"""Уважаемый студент! 
...
"""
TEXT_DOMINTORY = u"""Студенты ИЦТЭФ живут в Общежитии №4 по адрессу ул. Крупской д.103. 
...
"""
TEXT_IN_DOMINTORY = u"""Уважаемые студенты!  
...
"""
TEXT_FAQ = u"""Какой вопрос у тебя возник?"""
TEXT_VACIN = u"""На сегодняшний день вакцинация студентов от Covid-19 носит рекомендательный характер. Каждый из вас должен принять решение самостоятельно. Однако, ситуация может меняться.
...
"""
TEXT_ADMIN_HELP = u"""/add idtelegram НомерГруппы УровеньОбразования Курс - добавление пользователя\n id - идентификатор пользователя получить из /me \n номер группы \n уровень образования \n курс обучения
